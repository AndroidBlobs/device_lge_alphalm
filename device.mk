...
# IDC
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/idc/goodix_fp_key.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/goodix_fp_key.idc \
...
# Keylayout
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/keylayout/goodix_fp_key.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/goodix_fp_key.kl \
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.facerecognition.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.facerecognition.xml \
    ...
    frameworks/native/data/etc/android.hardware.vein.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.vein.xml \
